...
def get_arg():
    ...
    arg.add_argument('-bs', default=1708, type=int, help='batch size')
    arg.add_argument('-pre_epoch', default=300, type=int, help='epochs for train Autoencoder')
    arg.add_argument('-epoch', default=5000, type=int, help='epochs for train DEC')
    arg.add_argument('-k', default=2, type=int, help='num of clusters')
...
def main():
    ...
    opt = AdamW(ae.parameters(), weight_decay=0.01)
    t0 = time()
    #print(arg.pre_epoch)
    #exit()
